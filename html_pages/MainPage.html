...
echo "<input id='btnForget' type='button' class='forget' value='Forget Your Password?'";                        } ?>
    ...
    <div id="sticker">
      <table style="width:100%;" border="0">
        <tbody>
          <tr>
            <td class="bar"> <input id="lnkWhatIs" class="bar_links" value="What is Rest Admin?"

type="button"> <span class="bar_label">|</span> <input class="bar_links" value="Contact Us"
                            ...
                            <tbody>
                              <tr>
                                <td style="width: 100%;text-align:center;"> <span
                                    ...
                                    class="register">Register for a free trial</span>
                                </td>
                              </tr>
                              <tr>
                                <td> <br>
                              ...
                              <tr>
                                <td style="padding-left: 35px;"> <input class="registerinputs"

                                    type="text"> </td>
                              </tr>
                              <tr>
                                <td style="padding-left: 35px;"> <span class="registerform">Last
                                    Name:</span> </td>
                              </tr>
                              <tr>
                                <td style="padding-left: 35px;"> <input class="registerinputs"
                              ...
                              <tr>
                                <td style="padding-left: 35px;"> <span class="registerform">Repeat
                                    Password:</span> </td>
                              </tr>
                              <tr>
                                <td style="padding-left: 35px;"> <input class="registerinputs"
                              ...
                              <tr>
                                <td style="padding-left: 35px;"> <span class="registerform">Email:</span>
                                </td>
                              </tr>
                              <tr>
                                <td style="padding-left: 35px;"> <input class="registerinputs"
                              ...
                              <tr>
                                <td style="text-align: center;"> <input class="registersubmit"

value="Join Now" type="submit"> </td>
                              </tr>
                              <tr>
                                <td> <br>
                                </td>
